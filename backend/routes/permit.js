  ...
  try {
    ...
    const html = `
      ...
      <style>
        ...
        body { font-family: Tahoma, sans-serif; font-size: 12px; line-height: 1.4; border: 2px solid #000; padding: 20px; }
        ...
        footer { font-size: 11px; margin-top: 30px; border-top: 1px solid #ccc; padding-top: 8px; display: flex; justify-content: space-between; }
      </style></head>
      <body>
        <header>
        ...
        <footer>
          ...
          <div class="right">Date: ${new Date().toLocaleDateString()} Time: ${new Date().toLocaleTimeString()}</div>
        </footer>
      </body></html>
    `;
